...
namespace QuickTestr.Tests.Doc.Y_Challenges.A_Bound5;
...
")]
public class Bound5 : TestrTest<Bound5>
{
    ...
    protected override void Verify(Article article)
    {
        ...
        Assert.Equal("( [ ], [ ], [ ], [ -23457 ], [ -25242 ] )", article.Execution(1).Input(1).Read().Value);
        Assert.Equal("( [ ], [ ], [ ], [ -7527 ], [ -25242 ] )", article.Execution(1).Input(1).Read().Redux.Value);
